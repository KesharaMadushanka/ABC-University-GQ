                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#studentCollapse" role="button"
                           aria-expanded="false" aria-controls="studentCollapse">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#degreeCollapse" role="button"
                           aria-expanded="false" aria-controls="degreeCollapse">
                            <span class="menu-title">Degree Management</span>
                        </a>
                        <div class="collapse" id="degreeCollapse">
                            <ul class="nav flex-column sub-menu">
                    ...
                    <div class="col-md-3 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0 mt-2 text-danger">0.12% <span
