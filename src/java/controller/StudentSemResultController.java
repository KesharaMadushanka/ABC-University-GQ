...
@WebServlet(name = "StudentSemResultController", value = "/StudentSemResult")
public class StudentSemResultController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("user/studentSemResults.jsp").forward(request, response);
